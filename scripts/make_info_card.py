...
ROWS = [
    ("host",),
    ("kv", "Now", "Teaching Intern @ Sphoorthy Eng. College"),
    ("kv", "Prev", "Generative AI Engineer @ TheSmartBridge"),
    ("kv", "Also", "Salesforce Developer Intern"),
    ("kv", "Edu", "B.Tech Cybersecurity, Sphoorthy '27"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "C++ (DSA), Java"),
    ("kv", "AI / Cloud", "LLMs, Prompt Eng, GCP"),
    ("kv", "Salesforce", "Apex, LWC, SOQL/SOSL"),
    ("kv", "Security", "Ethical Hacking, Cybersecurity"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Salesforce Agentblazer Champion certified"),
    ("bul", "Hands-on GenAI + LLM deployment on GCP"),
]
